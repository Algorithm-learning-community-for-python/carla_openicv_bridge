...
struct TimeReference_
{
  ...
  _header_type header;
   ...
   typedef icv::Time _time_ref_type;
...
{
icv::message_operations::Printer< ::sensor_msgs::TimeReference_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
struct Printer< ::sensor_msgs::TimeReference_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sensor_msgs::TimeReference_<ContainerAllocator>& v)
  {
    ...
    s << indent << "time_ref: ";
    Printer<icv::Time>::stream(s, indent + "  ", v.time_ref);
    s << indent << "source: ";
