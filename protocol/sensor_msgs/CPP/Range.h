...
{
icv::message_operations::Printer< ::sensor_msgs::Range_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
# If you want a value added to this list, send an email to the icv-users list\n\
uint8 ULTRASOUND=0\n\
uint8 INFRARED=1\n\
\n\
