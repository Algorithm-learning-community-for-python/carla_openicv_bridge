...
class DecisionTrajectory(genpy.Message):
  _md5sum = "d07c52e707fc9c805fe4c0f8b804806a"
...
float64 w
"""
  __slots__ = ['trajectory','desired_speed','desired_acc']
  _slot_types = ['nav_msgs/Path','float32','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       trajectory,desired_speed,desired_acc
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2f().pack(_x.desired_speed, _x.desired_acc))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.desired_speed, _x.desired_acc,) = _get_struct_2f().unpack(str[start:end])
      return self
