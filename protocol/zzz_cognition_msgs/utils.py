...
from protocol.zzz_driver_msgs.msg import RigidBodyStateStamped
from protocol.zzz_cognition_msgs.msg import LaneState, MapState, RoadObstacle, JunctionMapState
from protocol.zzz_perception_msgs.msg import TrackingBoxArray, ObjectClass, DimensionWithCovariance
import numpy as np
...
def convert_tracking_box(array, pose):
    ...
    for obj in array.targets:
        if array.header.frame_id != pose.header.frame_id:
            ...
            abspose = trackpose
#get_absolute_state(trackpose, pose)
