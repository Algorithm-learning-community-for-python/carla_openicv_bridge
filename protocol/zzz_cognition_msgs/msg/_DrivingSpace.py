...
class DrivingSpace(genpy.Message):
  _md5sum = "5e93a01a1f757f48d222feaf83d1785c"
...
float64[9] covariance"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_f().pack(self.ego_lane_index))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v28.comments = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v29.child_frame_id = str[start:end].decode('utf-8')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v72.comments = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v73.child_frame_id = str[start:end].decode('utf-8')
        else:
