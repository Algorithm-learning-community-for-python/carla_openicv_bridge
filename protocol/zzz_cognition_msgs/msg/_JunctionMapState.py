...
class JunctionMapState(genpy.Message):
  _md5sum = "1f3b9f6bfcc838bb74c01486409b9908"
...
float64[9] covariance"""
  __slots__ = ['reference_path','drivable_area','obstacles']
  _slot_types = ['zzz_cognition_msgs/LaneState','geometry_msgs/Polygon','zzz_cognition_msgs/RoadObstacle[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       reference_path,drivable_area,obstacles
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.reference_path.map_lane.central_path_coeffs))
      buff.write(_get_struct_B().pack(self.reference_path.map_lane.central_path_type))
      ...
      buff.write(_get_struct_f().pack(self.reference_path.stop_distance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.reference_path.map_lane.central_path_coeffs = struct.unpack(pattern, str[start:end])
      start = end
      end += 1
      ...
      (self.reference_path.stop_distance,) = _get_struct_f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        if python3:
          _v62.comments = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v79.comments = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v80.child_frame_id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v96.comments = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v97.child_frame_id = str[start:end].decode('utf-8')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v174.comments = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v175.child_frame_id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v191.comments = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v192.child_frame_id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v208.comments = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v209.child_frame_id = str[start:end].decode('utf-8')
        else:
