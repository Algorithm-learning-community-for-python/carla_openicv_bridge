...
class LaneState(genpy.Message):
  _md5sum = "f6b4e8f9866318fc6e9a9050f2664f8f"
...
float64[9] covariance"""
  __slots__ = ['map_lane','stop_distance','front_vehicles','rear_vehicles']
  _slot_types = ['zzz_navigation_msgs/Lane','float32','zzz_cognition_msgs/RoadObstacle[]','zzz_cognition_msgs/RoadObstacle[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       map_lane,stop_distance,front_vehicles,rear_vehicles
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.map_lane.central_path_coeffs))
      buff.write(_get_struct_B().pack(self.map_lane.central_path_type))
      ...
      buff.write(_get_struct_f().pack(self.stop_distance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.map_lane.central_path_coeffs = struct.unpack(pattern, str[start:end])
      start = end
      end += 1
      ...
      (self.stop_distance,) = _get_struct_f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.front_vehicles = []
      for i in range(0, length):
        ...
        if python3:
          _v45.comments = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v46.child_frame_id = str[start:end].decode('utf-8')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v123.comments = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v124.child_frame_id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v140.comments = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v141.child_frame_id = str[start:end].decode('utf-8')
        else:
