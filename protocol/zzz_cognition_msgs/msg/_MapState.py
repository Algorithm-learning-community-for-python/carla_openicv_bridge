...
class MapState(genpy.Message):
  _md5sum = "bd9eb339e8192d13757b8bc09185e533"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.jmap.reference_path.map_lane.central_path_coeffs))
      buff.write(_get_struct_B().pack(self.jmap.reference_path.map_lane.central_path_type))
      ...
      for val1 in self.jmap.reference_path.map_lane.situations:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_f().pack(self.jmap.reference_path.stop_distance))
      ...
      for val1 in self.jmap.reference_path.front_vehicles:
        ...
        _x = val1
        buff.write(_get_struct_5f2B().pack(_x.lane_index, _x.lane_anglediff, _x.lane_dist_left_t, _x.lane_dist_right_t, _x.lane_dist_s, _x.static, _x.shape_type))
        _v21 = val1.shape
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sf'%length
        buff.write(struct.pack(pattern, *val1.shape_uncertainty))
        _x = val1
      ...
      for val1 in self.jmap.obstacles:
        ...
        _x = val1
        buff.write(_get_struct_2B().pack(_x.behavior, _x.priority))
      buff.write(_get_struct_f().pack(self.mmap.distance_to_junction))
      ...
      for val1 in self.mmap.lanes:
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sf'%length
        buff.write(struct.pack(pattern, *_v57.central_path_coeffs))
        buff.write(_get_struct_B().pack(_v57.central_path_type))
        ...
        for val3 in _v57.situations:
          ...
          if python3 or type(_x) == unicode:
            ...
            length = len(_x)
          buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_get_struct_f().pack(val1.stop_distance))
        ...
        for val2 in val1.front_vehicles:
          ...
          buff.write(_struct_I.pack(length))
          pattern = '<%sf'%length
          buff.write(struct.pack(pattern, *val2.shape_uncertainty))
          _x = val2
          buff.write(_get_struct_2B().pack(_x.behavior, _x.priority))
        ...
        for val2 in val1.rear_vehicles:
          ...
          buff.write(_get_struct_2B().pack(_x.behavior, _x.priority))
      _x = self
      buff.write(_get_struct_fb().pack(_x.mmap.ego_lane_index, _x.mmap.target_lane_index))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.ego_state.child_frame_id = str[start:end].decode('utf-8')
      else:
      ...
      self.jmap.reference_path.map_lane.central_path_coeffs = struct.unpack(pattern, str[start:end])
      start = end
      end += 1
      ...
      (self.jmap.reference_path.stop_distance,) = _get_struct_f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        if python3:
          _v102.comments = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v103.child_frame_id = str[start:end].decode('utf-8')
        else:
        ...
        val1.shape_uncertainty = struct.unpack(pattern, str[start:end])
        _x = val1
        start = end
        end += 2
      ...
      for i in range(0, length):
        ...
        if python3:
          _v119.comments = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v120.child_frame_id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v136.comments = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v137.child_frame_id = str[start:end].decode('utf-8')
        else:
      ...
      (self.mmap.distance_to_junction,) = _get_struct_f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.mmap.lanes = []
      for i in range(0, length):
        ...
        _v153.central_path_coeffs = struct.unpack(pattern, str[start:end])
        start = end
        end += 1
        ...
        for i in range(0, length):
          ...
          if python3:
            val3.comments = str[start:end].decode('utf-8')
          else:
            val3.comments = str[start:end]
          _v153.situations.append(val3)
        start = end
        end += 4
        (val1.stop_distance,) = _get_struct_f().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.front_vehicles = []
        for i in range(0, length):
          ...
          if python3:
            _v159.comments = str[start:end].decode('utf-8')
          else:
          ...
          if python3:
            _v160.child_frame_id = str[start:end].decode('utf-8')
          else:
          ...
          val2.shape_uncertainty = struct.unpack(pattern, str[start:end])
          _x = val2
          start = end
          end += 2
          (_x.behavior, _x.priority,) = _get_struct_2B().unpack(str[start:end])
        ...
        for i in range(0, length):
          ...
          if python3:
            _v176.comments = str[start:end].decode('utf-8')
          else:
          ...
          if python3:
            _v177.child_frame_id = str[start:end].decode('utf-8')
          else:
      ...
      (_x.mmap.ego_lane_index, _x.mmap.target_lane_index,) = _get_struct_fb().unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.mmap.lanes:
        ...
        buff.write(_get_struct_B().pack(_v249.central_path_type))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v294.comments = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v295.child_frame_id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v311.comments = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v312.child_frame_id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v328.comments = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v329.child_frame_id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            _v351.comments = str[start:end].decode('utf-8')
          else:
          ...
          if python3:
            _v352.child_frame_id = str[start:end].decode('utf-8')
          else:
        ...
        for i in range(0, length):
          ...
          if python3:
            _v368.comments = str[start:end].decode('utf-8')
          else:
          ...
          if python3:
            _v369.child_frame_id = str[start:end].decode('utf-8')
          else:
