...
class MultiLaneMapState(genpy.Message):
  _md5sum = "80055cf0854a708de43ef0a7f7f388d0"
...
float64[9] covariance"""
  __slots__ = ['distance_to_junction','lanes','ego_lane_index','target_lane_index']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       distance_to_junction,lanes,ego_lane_index,target_lane_index
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_f().pack(self.distance_to_junction))
      ...
      for val1 in self.lanes:
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sf'%length
        buff.write(struct.pack(pattern, *_v1.central_path_coeffs))
        buff.write(_get_struct_B().pack(_v1.central_path_type))
        ...
        for val2 in val1.rear_vehicles:
          ...
          buff.write(_get_struct_2B().pack(_x.behavior, _x.priority))
      _x = self
      buff.write(_get_struct_fb().pack(_x.ego_lane_index, _x.target_lane_index))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        _v41.central_path_coeffs = struct.unpack(pattern, str[start:end])
        start = end
        end += 1
        ...
        for i in range(0, length):
          ...
          if python3:
            _v47.comments = str[start:end].decode('utf-8')
          else:
          ...
          if python3:
            _v48.child_frame_id = str[start:end].decode('utf-8')
          else:
        ...
        for i in range(0, length):
          ...
          if python3:
            _v64.comments = str[start:end].decode('utf-8')
          else:
          ...
          if python3:
            _v65.child_frame_id = str[start:end].decode('utf-8')
          else:
      ...
      (_x.ego_lane_index, _x.target_lane_index,) = _get_struct_fb().unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.lanes:
        ...
        buff.write(_get_struct_B().pack(_v81.central_path_type))
    ...
    try:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            _v127.comments = str[start:end].decode('utf-8')
          else:
          ...
          if python3:
            _v128.child_frame_id = str[start:end].decode('utf-8')
          else:
        ...
        for i in range(0, length):
          ...
          if python3:
            _v144.comments = str[start:end].decode('utf-8')
          else:
          ...
          if python3:
            _v145.child_frame_id = str[start:end].decode('utf-8')
          else:
