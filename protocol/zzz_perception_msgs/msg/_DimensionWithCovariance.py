...
"""autogenerated by genpy from zzz_perception_msgs/DimensionWithCovariance.msg. Do not edit."""
import sys
...
class DimensionWithCovariance(genpy.Message):
  _md5sum = "ee5f3d39f08623c93a6f325eab556879"
  _type = "zzz_perception_msgs/DimensionWithCovariance"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# Describing the size object in 3D space (in meters) with uncertainty
...
float64[9] covariance"""
  __slots__ = ['length_x','length_y','length_z','covariance']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       length_x,length_y,length_z,covariance
    ...
    """
    if args or kwds:
      super(DimensionWithCovariance, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.length_x is None:
        self.length_x = 0.
      if self.length_y is None:
        self.length_y = 0.
      if self.length_z is None:
        self.length_z = 0.
