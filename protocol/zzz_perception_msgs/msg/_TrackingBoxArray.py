...
"""autogenerated by genpy from zzz_perception_msgs/TrackingBoxArray.msg. Do not edit."""
import sys
...
class TrackingBoxArray(genpy.Message):
  _md5sum = "18ed1d79cf3725caafe300a168ab735f"
  _type = "zzz_perception_msgs/TrackingBoxArray"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# Describe a list of 3D tracking targets, for a multi-object 3D detector.
...
"""
  ...
  _slot_types = ['std_msgs/Header','zzz_perception_msgs/TrackingBox[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrackingBoxArray, self).__init__(*args, **kwds)
