...
class DetectionBoxArray(genpy.Message):
  _md5sum = "dc7be8b3c0a3ae92ec8233b2d46beaa4"
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v17.encoding = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          val1.source_frame = str[start:end].decode('utf-8')
        else:
    ...
    try:
      ...
      for val1 in self.detections:
        ...
        if type(_x) in [list, tuple]:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_get_struct_B().pack(_v27.is_dense))
