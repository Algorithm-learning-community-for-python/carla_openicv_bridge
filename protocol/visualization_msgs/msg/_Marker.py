...
class Marker(genpy.Message):
  ...
  _full_text = """# See http://www.icv.org/wiki/rviz/DisplayTypes/Marker and http://www.icv.org/wiki/rviz/Tutorials/Markers%3A%20Basic%20Shapes for more information on using this message with rviz
