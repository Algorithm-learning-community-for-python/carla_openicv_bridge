...
# icvRUN: execute "icvrun" with arguments given in the command field (above).
# icvLAUNCH: execute "icvlaunch" with arguments given in the command field (above).
uint8 FEEDBACK=0
uint8 icvRUN=1
uint8 icvLAUNCH=2
uint8 command_type
...
# See http://www.icv.org/wiki/rviz/DisplayTypes/Marker and http://www.icv.org/wiki/rviz/Tutorials/Markers%3A%20Basic%20Shapes for more information on using this message with rviz
