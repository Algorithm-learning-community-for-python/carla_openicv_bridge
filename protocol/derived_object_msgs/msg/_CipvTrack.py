...
"""autogenerated by genpy from derived_object_msgs/CipvTrack.msg. Do not edit."""
import sys
...
class CipvTrack(genpy.Message):
  _md5sum = "db9a76b43a89517bb97bfea8c670557e"
  _type = "derived_object_msgs/CipvTrack"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# Closest In-Path Vehicle Radar Track
...
float64 y
float64 z"""
  __slots__ = ['header','is_valid','track']
  _slot_types = ['std_msgs/Header','bool','radar_msgs/RadarTrack']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CipvTrack, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_BH().pack(_x.is_valid, _x.track.track_id))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.is_valid, _x.track.track_id,) = _get_struct_BH().unpack(str[start:end])
