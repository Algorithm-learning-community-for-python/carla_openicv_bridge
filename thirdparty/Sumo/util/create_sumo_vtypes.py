...
with open('/home/yining/CARLA_0.9.9/Co-Simulation/Sumo/data/vtypes.json') as f:
    SPECS = json.load(f)
...
#accel="2.6" decel="4.5" sigma="0.5" length="5.0" minGap="1.5" maxSpeed="70" probability=".40" speedDev="0.1" guiShape="passenger/sedan"
    specs = {
        'id': vehicle.type_id,
